                        ...
                        @if($action)
                            <li class="block pb-4">
                                <form
                                    ...
                                    class="relative"
                                >
                                    <svg class="absolute top-3.5 left-0 w-4 h-4 text-gray-700 pointer-events-none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                    <input
                                        name="search"
                                        type="text"
                    ...
                    @if($action)
                        <li class="block pb-4">
                            <form
                                ...
                                class="relative"
                            >
                                <svg class="absolute top-3.5 left-0 w-4 h-4 text-gray-50 pointer-events-none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                <input
                                    name="search"
                                    type="text"
